...
const technicalSkillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Text-to-SQL", level: 80 },
      { name: "XGBoost", level: 75 },
      { name: "Scikit-Learn (Clustering)", level: 80 },
      { name: "Time Series Forecasting (Statsmodels)", level: 75 },
      { name: "Stable Diffusion", level: 75 },
      { name: "OpenCV", level: 80 },
      { name: "Pandas", level: 85 },
      { name: "NumPy", level: 85 },
      { name: "Generative AI APIs", level: 85 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Jupiter Notebook", level: 80 },
